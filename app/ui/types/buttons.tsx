...
import { disableType } from '@/app/lib/actions';
...
export function DisableType({ id, is_valid }: { id: string, is_valid: boolean }) {
  const toggleTypeStatus = disableType.bind(null, id, !is_valid);
  return (
    <form action={toggleTypeStatus}>
