...
import { Types, Branches } from '@/app/lib/definitions';

import Link from 'next/link';
import { Button } from '@/app/ui/button';
import { updateType, TypeState } from '@/app/lib/actions';
import { useActionState, useEffect, useState } from 'react';
import { Label } from "@/components/ui/label"
import { Switch } from "@/components/ui/switch"

export default function EditTypesForm({
    branches,
    selectedType,
    ...
    const updateTypeWithId = updateType.bind(null, selectedType.id.toString());
    ...
    const [type, setType] = useState<string>(selectedType.type);
    ...
    const getFilteredBranch = () => {
        ...
        return branches.filter(c => c.id === Number(selectedType.branch_id));
        // }
        // return branches;
    };
    ...
    return (
        <form action={formAction} className="w-full sm:w-1/2 md:w-1/3 mx-auto">
            ...
            <div className="mt-6 flex justify-end gap-4">
                ...
                <Button type="submit" disabled={isCheckingTypeName || !!typeNameError} className="disabled:opacity-50 disabled:cursor-not-allowed">Edit Type</Button>
            </div>
        </form >
    );
}
